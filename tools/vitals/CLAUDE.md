...
**[ANcpLua/vitals](https://github.com/ANcpLua/vitals)**. Its canonical local
checkout is `~/RiderProjects/qyl-workspace/vitals`. Code changes happen THERE,
with that repo's own history. This entry owns only the deployment record.
