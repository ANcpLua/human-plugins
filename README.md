...
| [disk-guard](tools/disk-guard/README.md) | Threshold-triggered disk cleanup: daily launchd check, prunes an allowlist of regenerable data only when free space < 25 GiB (federated: code in ANcpLua/disk-guard, private; deployment tracked here) | [CLAUDE.md](tools/disk-guard/CLAUDE.md) · [CHANGELOG.md](tools/disk-guard/CHANGELOG.md) |
